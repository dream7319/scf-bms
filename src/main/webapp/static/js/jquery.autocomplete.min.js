...
(function ($) {
    ...
    $.Autocompleter = function ($elem, options) {
        ...
        this.dom.$results = $("<div></div>").hide().addClass(this.options.resultsClass).css({position: "absolute"});
    ...
    $.Autocompleter.prototype.fetchRemoteData = function (filter, callback) {
        ...
        if (data) {
            ...
            $.ajax({
                url: this.makeUrl(filter), success: ajaxCallback, error: function (jqXHR, textStatus, errorThrown) {
    ...
    $.Autocompleter.prototype.createItemFromResult = function (result) {
        ...
        $li.data({value: result.value, data: result.data}).click(function () {
            self.selectItem($li)
