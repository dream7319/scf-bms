var customSwitch = {};
customSwitch.themeColor = "rgb(100, 189, 99)";
customSwitch.init = function() {
	var s = "<span class='switch-slider'></span>";
	...
	$("[class^=switch]").click(function() {
		...
		if ($(this).hasClass("switch-on")) {
			...
			if (customSwitch.themeColor) {
				var c = customSwitch.themeColor;
				$(this).css({
					'border-color' : c,
	...
	if ($('[themeColor]').length > 0) {
		$('[themeColor]').each(function() {
			var c = $(this).attr('themeColor') || customSwitch.themeColor;
			if ($(this).hasClass("switch-on")) {
				$(this).css({
					'border-color' : c,
					'box-shadow' : c + ' 0px 0px 0px 16px inset',
...
customSwitch.showOn = function(ele) {
...
customSwitch.showOff = function(ele) {
